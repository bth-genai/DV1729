# Lab 1
The examples in this folder require that you download models to your computer. The image generation examples use a specific folder structure for different models. .safetensors files and *-ubyte* files are ignored in the .gitignore file because of the large size of the models. The structure is the following:
